 ...
 */
public class lookforinterversity extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_lookforinterversity, container, false);
        rootView.setTag(TAG);




        recyclerView3 = (RecyclerView) rootView.findViewById(R.id.recyclerViewinterversity);
       ...
       /* mDatabase.orderByKey();*/
        ...
        //return inflater.inflate(R.layout.fragment_lookforinterversity, container, false);
    }
